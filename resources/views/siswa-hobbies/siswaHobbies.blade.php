<x-applayouts>
    ...
    <div class="card">
        <header class="card-header noborder">
            <h4 class="card-title">Tabel Hobi Siswa</h4>

            <div class="btn-group-example btn-group">
                <a href="/siswa-hobi/create" class="btn inline-flex justify-center btn-primary">Tambah Siswa</a>
            </div>
        </header>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-td ">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                <a href="/siswa-hobi/{{ $item->id }}/edit" class="action-btn" type="button">
    ...
    <tbody>
        @forelse ($siswa_hobi as $item)
            <tr>
                ...
                <td>{{ $item->nama }}</td>
                <td>{{ $item->phone_numbers->pluck('phone_number')->implode(', ') }}</td>
