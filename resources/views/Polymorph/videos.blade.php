...
<body>
    ...
    <div class="container p-4">
        ...
        <a href="/videos/create" class="btn btn-primary t-12">Tambah videos</a>
                ...
                @forelse ($videos as $item)
                    <tr>
                        ...
                        <td class="d-flex gap-2 items-center">
                            <a href="/videos/{{ $item->id }}/edit" class="btn btn-primary">Edit</a>
                            <a href="/videos/{{ $item->id }}" class="btn btn-warning">Detail</a>
        ...
        @foreach($videos as $item)
            <div class="modal fade" id="hapus{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog bg-white rounded-3">
                    <form action="/videos/{{$item->id}}" method="POST" class="modal-content">
                        @method('DELETE')
                        @csrf
