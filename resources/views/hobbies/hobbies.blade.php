<x-applayouts>
    ...
    <div class="card">
        <header class="card-header noborder">
            <h4 class="card-title">Tabel hobbies</h4>

            <div class="btn-group-example btn-group">
                <a href="/hobbies/create" class="btn inline-flex justify-center btn-primary">Tambah hobbies</a>
            </div>
        </header>
                            ...
                            <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                @forelse ($hobbies as $item)
                                    <tr>
                                        ...
                                        <td class="table-td ">{{ $item->hobby }}</td>
                                        ...
                                        <td class="table-td ">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                <a href="/hobbies/{{ $item->id }}/edit" class="action-btn" type="button">
                                                ...
                                                <form action="/hobbies/{{ $item->id }}/destroy" method="post">
                                                    @csrf
                                                    @method('DELETE')
